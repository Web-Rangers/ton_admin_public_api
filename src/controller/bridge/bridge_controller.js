...
const build_bridge_controller = function() {
    ...
    async function get_eth_bridge_transactions({params}) {
        return {status:200,message:{transactions:bridge_service.get_eth_bridge_transactions()}}
    }
    async function get_bsc_bridge_transactions({params}) {
        return {status:200,message:{transactions:bridge_service.get_bsc_bridge_transactions()}}
    }
}
